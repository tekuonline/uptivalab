    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center">
        <Card className="max-w-md text-center">
          ...
          <p className="text-slate-400">The status page you're looking for doesn't exist.</p>
        </Card>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          {data.monitors.length === 0 && (
            <p className="text-center text-slate-400 py-8">No services configured yet.</p>
          )}
        </div>
              ...
              return (
                <Card key={maintenance.id} className={`border-l-4 ${isActive ? 'border-yellow-500' : 'border-blue-500'}`}>
                  <div className="space-y-2">
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-lg font-semibold text-white">{maintenance.name}</h3>
                        <p className="text-sm text-slate-400">
